...
Lovely! There's one final step we should take, and that's the conversion of this
...
```{r reshape}
long_LOBdata <- melt(clean_LOBdata, id=c("match_ID", "lipid_class", "compound_name",
                                         "species", "peakgroup_mz", "peakgroup_rt"),
                     variable.name="Sample", value.name = "Intensity")

head(long_LOBdata)
```

Excellent. That's a data set we can work with!
